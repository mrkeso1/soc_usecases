...
urlpatterns = [
    ...
    path("export/full-csv/", export_usecases_full_csv, name="export_usecases_full_csv"),
    path("export/xlsx/", export_usecases_xlsx, name="export_usecases_xlsx"),
    path("import/csv/", import_usecases_csv, name="import_usecases_csv"),
