...
- `weasyprint==62.3`: generación de PDF desde HTML/CSS.
...
- Mapeo ATT&CK vía autocomplete, limitado a elementos habilitados.
- D3FEND se infiere automáticamente desde ATT&CK y relaciones D3FEND→ATT&CK habilitadas.
...
- Se renderiza con WeasyPrint desde `templates/reports/dashboard_pdf.html`, permitiendo estilos CSS y mejor paginado.
...
- Los formularios/autocomplete solo ofrecen ATT&CK habilitados para nuevos mapeos.
- D3FEND ya no se carga manualmente en UI; se deriva por inferencia.
